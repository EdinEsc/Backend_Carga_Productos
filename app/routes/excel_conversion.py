# # =========================
# # excel_conversion.py (VERSIÓN FINAL - CON ORDEN EXACTO DE COLUMNAS)
# # =========================
...
#     # W-TIENDA1 con nombre dinámico (pero la columna se llama W-TIENDA1 en el Excel final)
#     df_base["W-TIENDA1"] = df_base["stock"]
...
#         # 👇 ASEGURAR EL ORDEN EXACTO EN LA HOJA productos
#         productos_ok.to_excel(writer, index=False, sheet_name="productos")
